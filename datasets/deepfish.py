...
class DeepFish(LT_Dataset):
    classnames_txt = "./datasets/DeepFish/classnames.txt"
    train_txt = "./datasets/DeepFish/DeepFish_train.txt"
    test_txt = "./datasets/DeepFish/DeepFish_test.txt"
