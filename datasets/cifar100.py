...
class CorruptCIFAR(Dataset):
    def __init__(self, root='/data00/jiahao/data/CIFAR-100-C', name='', transform=None) -> None:
        # super().__init__()
        path = os.path.join(root, name)
        self.images = np.load(path)[10000:20000]
        self.labels = np.load('/data00/jiahao/data/CIFAR-100-C/labels.npy')
